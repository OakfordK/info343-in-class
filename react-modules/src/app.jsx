...
// Importing search-form function
import SearchForm from "./search-form.jsx";
import Repo from "./repo.jsx";


// Sends it for other files to use when they import this file
    ...
    render() {
        return (
            <main className="container">
                ...
                {
                    this.state.data.items.map(repo => <Repo repo={repo}/>)
                }
